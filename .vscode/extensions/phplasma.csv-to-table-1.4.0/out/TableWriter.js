...
class TableWriter {
     ...
     */
    getFormattedTable(records, upperCaseHeader, useMarkdownFormat, rightAlignNumbers) {
        // Get column lengths
     ...
     */
    getFormattedRecord(record, columnLengths, useValuePadding, upperCaseValue, rightAlignNumbers) {
